...
static esp_err_t bsp_i2s_init(i2s_port_t i2s_num, uint32_t sample_rate, i2s_slot_mode_t channel_format, i2s_data_bit_width_t bits_per_chan)
{
    ...
    // Cấu hình I2S cho micro INMP441
    i2s_std_config_t std_cfg = {
        .clk_cfg = I2S_STD_CLK_DEFAULT_CONFIG(sample_rate),
        .slot_cfg = I2S_STD_PHILIPS_SLOT_DEFAULT_CONFIG(bits_per_chan, channel_format),
        .gpio_cfg = {
            .mclk = GPIO_I2S_MCLK,
            .bclk = GPIO_I2S_SCLK,
            .ws   = GPIO_I2S_LRCK,
...
{
    bsp_i2s_init(I2S_NUM_0, 16000, I2S_SLOT_MODE_MONO, I2S_DATA_BIT_WIDTH_32BIT);
